...
namespace Dapper.MoqTests
{
    ...
    {
        public bool Matches(DbCommand command, SqlMapper.Identity identity)
        {
        ...
        public bool TextMatches(DbCommand command, SqlMapper.Identity identity)
        {
            return identity.sql == command.CommandText;
        }

        private static bool ParametersMatch(SqlMapper.Identity identity, DbCommand mockDbCommand)
        {
        ...
        private static bool CommandTypeMatches(SqlMapper.Identity identity, DbCommand mockDbCommand)
        {
